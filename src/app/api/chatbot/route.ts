...
// Function to get providers information
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log('Is provider query:', isProviderQuery)
    ...
    if (isSalonQuery) {
      ...
      console.log('Fetching providers information from database...')
      queryType = 'providers'
      ...
      if (providersData) {
        ...
        finalReply = 'Lo siento, no pude acceder a la información de proveedores en este momento. Por favor, intenta más tarde.'
      }
    } else {
