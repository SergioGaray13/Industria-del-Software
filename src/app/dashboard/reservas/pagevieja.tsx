...
export default function ReservasPage() {
  ...
  const fetchReservas = async () => {
    ...
    const { data, error } = await supabase
      ...
      .eq('usuario_id', session.user.id) // CORREGIDO: usuario_id, no usuarioId
  ...
  return (
    <div className="min-h-screen bg-orange-50 p-6">
      <h1 className="text-3xl font-bold text-orange-600 mb-6 text-center">Mis Reservas</h1>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-lg animate-fade-in">
            ...
            <p className="text-sm text-gray-700 mb-4 text-center">
              Salón: <strong>{reservaAEliminar.salon.nombre}</strong><br />
